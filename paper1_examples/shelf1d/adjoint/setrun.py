...
#------------------------------
    ...
    probdata.add_param('start',     -50.e3,  'start of slope')
    probdata.add_param('x1', -10000., 'Left edge of target region')
    probdata.add_param('x2', -25000., 'Right edge of target region')
