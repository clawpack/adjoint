...
#------------------------------
    ...
    # 1 degree grid: 174 by 112; 2degree grid: 87 by 56 cells.
    # 24 min grid: 435 by 280; 12 min grid: 870 by 560
    # Number of grid cells: 15minute grid: 696 by 448

    

    clawdata.num_cells[0] = 696      # mx
    clawdata.num_cells[1] = 448      # my
    ...
    if clawdata.output_style==1:
        ...
        clawdata.num_output_times = 26*2
        clawdata.tfinal =  26*3600.
...
#-------------------
    ...
    # The 1 minute file files.  The new ones including Chile
    topo_data.topofiles.append([3, 1, 1, 0., 1.e10, \
