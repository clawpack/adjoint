...
#------------------------------
    ...
    if clawdata.output_style==1:
        ...
        #clawdata.num_output_times = 14*2
        #clawdata.tfinal =  14*3600.

        clawdata.num_output_times = 15*2
        clawdata.tfinal =  15*3600.
    ...
    # refine along West Coast: might want to make bigger: -126, -114, 29, 51 
    # ASK
    #regions.append([2,2,0.,4*3600, -126,-122, 35,46])
    regions.append([2,2,0.,4*3600, -126,-114, 29,51])
...
#-------------------
    ...
    ### ASK if we need the 1 min data
    ## The 1 minute file.  This is a big swatch of the ocean
    #  for the Samoa runs to allow for 1 minute computation
    #topo_etopo_dir = '../../topo/etopo/'
    topo_data.topofiles.append([3, 1, 1, 0., 1.e10, \
        topo_dir+'etopo1_-180_-110_-20_60_1min.tt3'])
