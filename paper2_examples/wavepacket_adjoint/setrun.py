...
#adjoint_flag_tolerance = 0.1e-4       # suggested if using forward solution
adjoint_flag_tolerance = 0.1           # suggested if using Richardson error
#-----------------------------------------------
...
#------------------------------
    ...
    clawdata.dt_initial = 1.000000e-08
    ...
    amrdata.refinement_ratios_x = [2,2,2,2,2,2,2,2,2,2,2,2,2,2]
    amrdata.refinement_ratios_t = [2,2,2,2,2,2,2,2,2,2,2,2,2,2]
