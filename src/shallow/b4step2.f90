...
!
! This routine is modified from the GeoClaw b4step2.f90
! In addition to the default behavior, it calculates the 
! innerproduct values for the grid.
    ...
    use adjoint_module, only: set_innerproduct_field
    ...
    ! Set inner product aux variable for this grid
    call set_innerproduct_field(maux,mbc,mx,my,xlower,ylower,dx,dy, &
                               t,aux,q,meqn)
